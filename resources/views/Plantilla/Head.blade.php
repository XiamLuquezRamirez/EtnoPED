<head>
    ...
    <title>@yield('title', 'Plataforma Educativa Digital') - EtnoPED</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('app-assets/vendors/css/forms/quill/katex.min.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('app-assets/vendors/css/forms/quill/monokai-sublime.min.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/cards.css') }}">
