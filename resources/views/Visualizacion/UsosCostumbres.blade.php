                            ...
                            <div id="conte-Uso" style="display: none;" class="row match-height" style="width: 100%;">
                                        ...
                                        <div class="card-header">
                                            ...
                                            <div class="heading-elements">
                                                <ul class="list-inline mb-0">
                                                    <li><a data-action="expand"><i class="feather icon-maximize"></i></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div id="div-lateral" class="col-sm-12 col-md-4" style="">
                                    <div id="card-costumbres" class="card"
                                        ...
                                        <div class="card-header">
                                            <h4 class="card-title">Costumbres</h4>
                                            <a class="heading-elements-toggle"><i
                                                    class="fa fa-ellipsis-v font-medium-3"></i></a>
                                            <div class="heading-elements">
                                                <ul class="list-inline mb-0">
        ...
        $(document).ready(function() {
            ...
            $.extend({
                        ...
                        success: function(response) {
                            ...
                            if (response.detUsos.url_video != "") {
                                ...
                                let url = $('#urlMult').data("ruta") +
                                    ...
                                    response.detUsos.url_video;

                                ContentVidCostumbres.innerHTML =
                                    '<video id="vidCost"  style="width: 100%;"  controls><source  src="' +
                                    url +
                            ...
                            if (response.evaluaciones.length > 0) {
                                ...
                                $("#listEvalCostumbres").html(listEval);
                            } else {
                ...
                atrasUsos: function() {
                    ...
                    $("#div-Uso").show();
                    $("#conte-Uso").hide();
                    $("#titulo-usos").html('Listado de Usos y Costumbres');
                },
                MostVid: function() {
